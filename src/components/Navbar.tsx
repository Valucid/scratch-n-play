    ...
    <nav className="relative z-40 p-4 text-gray1 bg-light">
      <div className="container flex items-center justify-between mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-4 xl:space-x-10 text-sm">
          ...
          {token && (
              <button className="bg-[#ED222F] text-light py-2 px-4 rounded-lg font-semibold" onClick={() => dispatch(logOut())}>
                Log Out
              </button>
            )}
        </div>
        ...
        >
          ...
          <div className="flex flex-col space-y-4 mt-10 text-xl tracking-tighter font-medium">
            {renderedLinks}
